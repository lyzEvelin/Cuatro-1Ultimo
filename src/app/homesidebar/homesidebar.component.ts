...
import { DatosAbiertosService } from '../../../src/app/services/datos-abiertos.service';
...
export class HomesidebarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.TroncalBoton = this._DatosAbiertosService.getTroncales();
    ...
    public getEstaciones(data) {
        this.EstacionBoton = this._DatosAbiertosService.getEstaciones(data);
